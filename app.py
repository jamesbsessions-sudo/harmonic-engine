...
def quantise_melody_to_grid(melody_data, beat_times, tempo, beats_per_bar, key):
    ...
    for note in note_events:
        ...
        is_on_grid = abs(swing_fraction) < 0.3  # Within 30% of a 16th = on grid
        ...
        grid_melody.append({
            ...
            "duration_16ths": quantised_16ths,
            "time_seconds": round(note["start"], 3),
            "on_grid": is_on_grid,
            "swing_offset": round(swing_fraction, 3),
        })

...
def extract_melody(audio: np.ndarray, sr: int = 44100):
    """
    Use librosa pyin to extract vocal melody from the vocal stem.
    
    pyin is a probabilistic pitch tracker designed for monophonic signals.
    On a clean Demucs vocal stem it should behave similarly to Logic's Flex Pitch.

...
def analyse_drum_patterns(drum_path: str, beat_times, sr=44100):
    ...
    if len(snare_onsets) > 2 and len(beat_times) > 1:
        ...
        # Count how many snare intervals are close to 2-beat spacing
        regular_count = 0
        for si in snare_intervals:
            # Within 30% of the expected 2-beat interval
            if abs(si - two_beat_interval) < two_beat_interval * 0.3:
                regular_count += 1
        ...
        if snare_regularity > 50 and 0.6 < density_ratio < 1.5:
